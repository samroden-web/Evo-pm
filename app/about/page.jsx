...
export const metadata = {
  title: 'About EVO',
  description:
    'EVO is a fully managed, fixed-price repairs service for housing landlords: why we exist, the people behind it, the social value the contract puts back, and the health, safety and environment record a PQQ asks about.',
...
// Board as listed on the current site, plus Sam Roden. Brief 6.12: EVO will send an
// updated team list — add photographs to /public/images/team/ when it arrives.
const BOARD = [
  {
    name: 'Kate Davies CBE',
    role: 'Non-Executive Director',
    bio: 'Chief Executive of Notting Hill Genesis for 18 years, and a long-standing champion of innovation in housing.',
  },
  {
    name: 'Steve Norris',
    role: 'Chairman',
    bio: 'FRICS, and a former Government Minister for Transport.',
  },
  {
    name: 'Mark Iandoli',
    role: 'Co-founder and COO',
    bio: 'Twenty-five years in UK property maintenance before founding EVO.',
  },
  { name: 'Steven Rae', role: 'CEO and CTO' },
  { name: 'Craig Calder', role: 'Commercial Director' },
  { name: 'Sam Roden', role: 'Non-Executive Director' },
...
const SOCIAL_VALUE = [
  ...
  ['Local tradespeople employed', 'In and around the properties we look after, rather than travelling in from another county.'],
  [
    ...
    <>
      ...
      <section className="section" aria-labelledby="why-title">
        <div className="container container--narrow prose">
          ...
          <p>
            A resident does not experience their landlord&rsquo;s strategy, their development pipeline or their board papers. They
            experience whether the heating works, whether anyone turned up, and whether they were told what was happening. Repairs
            is where trust is built or lost, and for years it has been the part of the sector run with the least technology and the
            least accountability.
          </p>
          <p className="mb-0">
            We did not set out to build software. We set out to fix the way the work gets done, and found there was nothing on the
            market that would let us do it. So we built that too, and it is the reason we can put a fixed price on a repairs service
            at all.
          </p>
        </div>
      </section>
      ...
      <section className="section section--navy" aria-label="Why EVO was founded">
      ...
      <section className="section" id="who-we-are" aria-labelledby="who-title">
        <div className="container">
          <div className="section-head">
            ...
            <p className="lead">
              An operations business first. Most of our people come from trades, housing or repairs management rather than from
              technology, and the company is still run by the people who started it.
            </p>
          </div>
          <div className="grid-3 mt-3 grid-2-mobile">
            {BOARD.map((p) => (
              <div className="card card--grey" key={p.name}>
                <h3 className="mb-0">{p.name}</h3>
                <p className="eyebrow mt-1">{p.role}</p>
                {p.bio && <p className="mb-0">{p.bio}</p>}
              </div>
            ))}
          </div>
          <p className="mt-3">
            We are members of the <strong>CIH Repairs and Maintenance Community</strong>, informing government and sharing best
            practice, and of the <strong>PropTech Peer Group</strong>, working to bring effective innovation to the housing sector.
          </p>
          <Tbc block>
            Updated team list, bios and photographs (EVO to send). Operations, helpdesk and development teams to follow, and the
            current site shows all of them.
          </Tbc>
        </div>
      </section>
      ...
      <section className="section section--grey" id="social-value" aria-labelledby="sv-title">
        <div className="container">
          <div className="section-head">
            ...
            <p className="lead">
              Social value is scored in your procurement, so it should be specific rather than aspirational. This is what we
              actually do, and it is negotiable at contract stage.
            </p>
          </div>
        ...
        <div className="container">
          <div className="section-head">
            ...
            <p className="lead mb-0">
              We work with local authority housing companies, housing associations, charities and institutional landlords, and we
              are on the main public-sector frameworks for repairs and maintenance.
            </p>
          </div>
        </div>
      </section>

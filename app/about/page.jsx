    ...
    <>
      ...
      <section className="section" id="who-we-are" aria-labelledby="who-title">
        <div className="container">
          ...
          <Tbc block>
            Team photographs. The files are on the current site but could not be pulled into this repo automatically &mdash; run
            <code> tools/fetch-team-photos.sh </code> from a machine with internet access and they drop straight into
            /public/images/team. Sam Roden&rsquo;s photograph and the board biographies for Steve Norris are still to come.
          </Tbc>
        </div>
      </section>

        ...
        <div className="ev3-voxpop">
          <figure className="ev3-voxpop-player">
            <video
              ...
              height={1280}
            >
              <source src="/video/evo-resident-voxpop.mp4" type="video/mp4" />
          ...
          <div>
            ...
            <p className="lead">
              Residents in their own kitchens and doorways, talking about reporting a repair on the EVO Living App. Not a
              scripted case study &mdash; we asked, and this is what they said.
            </p>
            <p>
              Resident satisfaction is one of the Tenant Satisfaction Measures you are reported against, and repairs is the part
              of it residents feel most directly. It is also the part of a supplier&rsquo;s pitch you can check for yourself,
              which is why it is here rather than in a slide.
            </p>
            <p className="mb-0">

...
// Three different KINDS of voice: a residents' association, a landlord from a third
// client, and a resident. Craig Jackson's quote is four times the length of the others,
// which is why an audit finding had been dropped in here instead — but "Internal audit of
// the EVO and IDS partnership" is not a name, and a quote with no person on it is the
// weakest thing you can put in a proof block. The row now carries uneven lengths, so the
// real name goes back.
const ALSO = [testimonials.matthewLismore, testimonials.craigJackson, testimonials.nasir];
